...
interface OkxTransactionDetailsModalProps {
  detailsModalType: OkxDetailsModalType;
  setDetailsModalType: (type: OkxDetailsModalType) => void;
  stats: OkxTxStats;
...
export function OkxTransactionDetailsModal({
  detailsModalType,
  setDetailsModalType,
  stats,
  filteredEntries,
  ...
  maskVal,
  isPrivateMode,
}: OkxTransactionDetailsModalProps) {
