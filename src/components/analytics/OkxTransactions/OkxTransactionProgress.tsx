...
interface OkxTransactionProgressProps {
  isSyncing: boolean;
  progress: { pct: number; records: number } | null;
}

export function OkxTransactionProgress({ isSyncing, progress }: OkxTransactionProgressProps) {
  ...
  return (
    <AppTooltip
      description="Progress of the OKX bills/transaction log backfill. Syncs up to 3 months of archive data progressively."
      rows={[
