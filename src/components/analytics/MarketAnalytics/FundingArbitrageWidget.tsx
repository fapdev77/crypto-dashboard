...
export const FundingArbitrageWidget: React.FC = () => {
  const { snapshot, selectedMarkets, selectAllMarkets, setSelectedSymbol } = useMarketAnalyticsStore();
    ...
    return (
      <div className="bg-[#121318] border border-[#2a2b30] rounded-xl p-5 shadow-lg flex flex-col items-center justify-center text-center space-y-3 min-h-[220px]">
        ...
        <div className="max-w-md">
          <h3 className="text-base font-semibold text-white">Funding Rates Require Derivatives Markets</h3>
          <p className="text-xs text-[#8E9299] mt-1 leading-relaxed">
            Funding rates are exchanged periodically between long and short contract holders in Perpetual and Inverse futures. Spot markets settle immediately and do not carry funding fees.
          </p>
        </div>
        <button
        ...
        >
          View Consolidated Derivatives Funding
        </button>
      </div>
    );
  }
